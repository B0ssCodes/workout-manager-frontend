...
const backExercises = BackData.map((exercise) => {
                    ...
                    <div className="card-body">
                        ...
                        {selectedExercise === exercise.key && (
                            <form onSubmit={(event) => handleExerciseSubmit(event, exercise.title, formData[exercise.key])}>
                                ...
                                <button type="submit" className="btn btn-primary" id="liveToastBtn" onClick={() => setToastId(currentToastId)}>Submit Exercise</button>
                            </form>
                        )}
                    </div>
                </div>
    ...
    return (
        <section id="back">
            <h2 className="display-6 border-bottom my-4">Back</h2>
